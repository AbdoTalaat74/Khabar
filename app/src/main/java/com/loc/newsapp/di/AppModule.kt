...
import com.loc.newsapp.domain.uscases.GetNewsUseCase
import com.loc.newsapp.domain.uscases.NewsUseCases
...
object AppModule {
    ...
    fun provideNewsUseCases(newsRepository: NewsRepository):NewsUseCases{
        return NewsUseCases(getNewsUseCase = GetNewsUseCase(newsRepository))
    }
}